import 'package:bil_bakalim/sqllite/model/todom.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:bil_bakalim/sqllite/utils/dbhelper.dart';
...
class TodoDetailState extends State {
  ...
  final _priorities = ["Yüksek Öncelik", "Orta Öncelik", "Düşük Öncelik"];
  String _priority = "Düşük Öncelik";
  ...
  Widget build(BuildContext context) {
    ...
    var title = todo.title == "" ? "Görüşleriniz" : todo.title;
    return Scaffold(
        appBar: AppBar(
            ...
            children: [
              ...
              Padding(
                ...
                child: TextField(
                    ...
                    keyboardType: TextInputType.text,
                    decoration: InputDecoration(
                        labelText: "Uygulamamız Hakkındaki Görüşleriniz...",
                        labelStyle: textStyle,
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(5.0)))),
              ),
