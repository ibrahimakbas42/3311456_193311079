class Todo {
  ...
  Map<String, dynamic> toMap() {
    ...
    map["Adınız/Soyadınız"] = _title;
    map["Uygulamamız Hakkındaki Görüşleriniz"] = _description;
  ...
  Todo.fromObject(dynamic o) {
    this._id = o["id"];
    this._title = o["Adınız/Soyadınız"];
    this._description = o["Uygulamamız Hakkındaki Görüşleriniz"];
