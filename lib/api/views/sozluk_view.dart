import 'dart:async';
import 'package:bil_bakalim/api/services/sozluk_services.dart';
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                String image_url = data["definitions"][index]["image_url"] ??
                    "https://media.owlbot.info/dictionary/images/hhhhhhhhhhhhhhhhhhhu.jpg";
                String type = data["definitions"][index]["type"];
                String definition = data["definitions"][index]["definition"];
                String example =
                    data["definitions"][index]["example"] ?? "example is null";
                return ListBody(
                  children: [
                    Container(
